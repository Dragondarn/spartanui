...
---------------------------------------------------------------------------------------------------
SUIL = {}
setmetatable(SUIL,{__index = LANG}); -- this forces any lookup in SUIL that would normally return nil to backreference LANG for a match

SUIL.AVAILABLE_LANGUAGES = { -- is this even needed anymore?
...
function SUIL:GetLanguage(lang)
	lang = string.upper(lang) or "ENGLISH";
	fixFontObjects()
	return LANG[lang];
end

SUI_Lang = SUI_Lang or SUIL:GetLanguage("ENGLISH")
