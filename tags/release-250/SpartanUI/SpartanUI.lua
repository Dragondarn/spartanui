-- this isnt actually in use yet, but it will be before release ----------------------------------
local Sui = LibStub("AceAddon-3.0"):NewAddon("SpartanUI")
...
---------------------------------------------------------------------------------------------------
local CurrentVersion = 20081013; -- 2.5
...
---------------------------------------------------------------------------------------------------
function Sui.OnInitialize() -- automatically executed at ADDON_LOADED
...
function Sui_BarFix()
	...
	if BT4BarBagBar then
		...
		if not SUI_BT4 then
			BT4BarBagBar:SetPoint("LEFT", BT4BarMicroMenu, "RIGHT", -5, 0)
...
function Sui_SetupMembers(toon,task)
	...
	if UnitClass("player")~="Death Knight" or UnitClass(toon)~="Death Knight" or UnitClass("target")~="Death Knight" then
...
function Sui_OnEvent()
	...
	elseif event=="PLAYER_ENTERING_WORLD" then
		...
		FramerateLabel:SetPoint("CENTER", "WorldFrame", "BOTTOM", -15, 225)
