...
---------------------------------------------------------------------------------------------------
-- Beladona: moved everything to a local as it saves memory, and SUI_Lang can link to them anyway
---------------------------------------------------------------------------------------------------
SUIL = {}
...
SUI_Lang = SUI_Lang or LANG.ENGLISH
DEFAULT_CHAT_FRAME:AddMessage("SpartanUI " .. SUI_Lang.UI.LANGUAGE .. " loaded.", 1, 0.75, 0)

function SUIL:SetLanguage(lang)
	lang = string.upper(lang) or "ENGLISH";
	if (SUI_Lang ~= LANG[lang]) then
		SUI_Lang = LANG[lang];
	end
end

if (SUI_Lang == LANG.RUSSIAN) or (SUI_Lang == LANG.SIMPLIFIED_CHINESE) or (SUI_Lang == LANG.TRADITIONAL_CHINESE) then
	SUI_Self_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_Target_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_Party1_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_Party2_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_Party3_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_Party4_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_Pet_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_Focus_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_TOT_Name:SetFontObject(SUI_FontTitle_Lang)
	SUI_MouseTooltip_Text:SetFontObject(SUI_FontTitle_Lang)
end
...
---------------------------------------------------------------------------------------------------
Sui_InitializeLanguages = function()
	-- this is a stub for a function that is no longer in use
end

SUIL.ENGLISH = LANG.ENGLISH